...
# urdf_path = Path("/home/chris/tilde/config_system/robot_descriptions/crb15000_5_95/crb15000_5_95.urdf")
...
#     result_flange_xyz: np.ndarray = urdf.get_transform(frame_to="flange", frame_from="base_link")[:3, 3]

#     errors = expected_flange_xyz - result_flange_xyz
#     assert np.sum(np.abs(errors)) < 0.01, f"{expected_flange_xyz}-{result_flange_xyz}={errors}"
