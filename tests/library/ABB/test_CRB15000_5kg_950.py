...
def test_fk_one():
    ...
    expected_flange_xz = np.array([0.571, 0.899])
...
def test_fk_two():
    ...
    expected_flange_xz = np.array([0.0, 1.320])
    urdf.update_cfg(np.deg2rad(joint_angles_degrees))
    result_flange_xz: np.ndarray = urdf.get_transform(
        frame_to="flange", frame_from="base_link"
    )[:3, 3][[0, 2]]
...
def test_fk_three():
    ...
    expected_flange_xz = np.array([1.055, 0.265])
    urdf.update_cfg(np.deg2rad(joint_angles_degrees))
    result_flange_xz: np.ndarray = urdf.get_transform(
        frame_to="flange", frame_from="base_link"
    )[:3, 3][[0, 2]]
...
def test_fk_four():
    ...
    expected_flange_xz = np.array([0.0, -0.790])
    urdf.update_cfg(np.deg2rad(joint_angles_degrees))
    result_flange_xz: np.ndarray = urdf.get_transform(
        frame_to="flange", frame_from="base_link"
    )[:3, 3][[0, 2]]
...
def test_fk_six():
    ...
    expected_flange_xz = np.array([-0.611, -0.179])
    urdf.update_cfg(np.deg2rad(joint_angles_degrees))
    result_flange_xz: np.ndarray = urdf.get_transform(
        frame_to="flange", frame_from="base_link"
    )[:3, 3][[0, 2]]
...
def test_fk_seven():
    ...
    expected_flange_xz = np.array([-0.191, 0.401])
    urdf.update_cfg(np.deg2rad(joint_angles_degrees))
    result_flange_xz: np.ndarray = urdf.get_transform(
        frame_to="flange", frame_from="base_link"
    )[:3, 3][[0, 2]]
...
def test_fk_nine():
    ...
    expected_flange_xz = np.array([0.323, 0.340])
    urdf.update_cfg(np.deg2rad(joint_angles_degrees))
    result_flange_xz: np.ndarray = urdf.get_transform(
        frame_to="flange", frame_from="base_link"
    )[:3, 3][[0, 2]]
